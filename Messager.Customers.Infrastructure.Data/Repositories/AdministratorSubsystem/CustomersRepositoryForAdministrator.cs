...
{
    public class CustomersRepositoryForAdministrator : RepositoryBase<Customer>, ICustomersRepositoryForAdministrator
    {
        public CustomersRepositoryForAdministrator(RepositoryContext context)
            : base(context)
        {
        }
